...
public class WorkbookMainGui extends javax.swing.JFrame implements WorkbookListener {
	...
	/*
	 * if ((jScrollPane1.getVerticalScrollBar().getValue() + verticalExtent) ==
	 * jScrollPane1.getVerticalScrollBar() .getMaximum()) { sizeRows++;
	 * TableModel model = (CustomTableModel) jTable1.getModel();
	 * model.setRowCount(++sizeRows); } if
	 * ((jScrollPane1.getHorizontalScrollBar().getValue() + horizontalExtent) ==
	 * jScrollPane1 .getHorizontalScrollBar().getMaximum()) { sizeColumns++;
	 * TableModel model = (CustomTableModel) jTable1.getModel();
